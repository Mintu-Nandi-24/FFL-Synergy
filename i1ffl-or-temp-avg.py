...
np.savetxt('i1ffl-intx-etaz_path.dat', np.column_stack((intx_array, z_path_array)), comments='', fmt="%.6f", delimiter="\t")
np.savetxt('i1ffl-intx-rel_etaz_cross.dat', np.column_stack((intx_array, rel_z_cross_array)), comments='', fmt="%.6f", delimiter="\t")
np.savetxt('i1ffl-intx-Hz.dat', np.column_stack((intx_array, Hz_array)), comments='', fmt="%.6f", delimiter="\t")
np.savetxt('i1ffl-intx-Hz_path.dat', np.column_stack((intx_array, Hz_path_array)), comments='', fmt="%.6f", delimiter="\t")
np.savetxt('i1ffl-intx-Hz_cross.dat', np.column_stack((intx_array, Hz_cross_array)), comments='', fmt="%.6f", delimiter="\t")
np.savetxt('i1ffl-intx-Ixz.dat', np.column_stack((intx_array, Ixz_array)), comments='', fmt="%.6f", delimiter="\t")
np.savetxt('i1ffl-intx-Ixz_path.dat', np.column_stack((intx_array, I_path_array)), comments='', fmt="%.6f", delimiter="\t")
np.savetxt('i1ffl-intx-Ixz_cross.dat', np.column_stack((intx_array, I_cross_array)), comments='', fmt="%.6f", delimiter="\t")
